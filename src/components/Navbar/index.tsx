            ...
            <nav aria-label="breadcrumb" className="w-full py-1 px-2">
              <ol className="flex space-x-3">
                <li className="flex items-center">
                  <a
                    href="/"
                    className="flex items-center text-black/40 dark:text-white/40 hover:text-black dark:hover:text-white"
                  >
                    Dashboard
                  </a>
                </li>
          ...
          <form className="md:flex items-center hidden">
            ...
            <div className="relative w-full">
              ...
              <input
                type="text"
                id="voice-search"
                className="bg-black/5 dark:bg-black/20 border-0 text-black dark:text-white/40 text-sm rounded-lg block max-w-[160px] w-full px-[26px] p-1 focus:ring-0 focus:outline-0"
                placeholder="Search..."
                required
              />
