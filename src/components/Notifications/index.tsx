...
const NotificationBar: React.FC<NotificationBarProps> = ({ isOpen }) => {
    return (
        <div
            className={`fixed top-0 right-0 h-full w-[280px] shadow-lg transform ${isOpen ? 'translate-x-0' : 'translate-x-full'
                } transition-transform duration-300 ease-in-out z-50 `}
        >
            <div className="right-sidebar fixed right-0 bottom-0 z-50 w-[280px] border-l border-black/10 dark:border-white/10 transition-all duration-300">
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <div className="flex gap-2">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-xs text-black/40 dark:text-white/40">59 minutes ago</p>
                                </div>
                            </div>
                            <div className="flex gap-2">
                                <div className="h-6 w-6 flex-none p-1 text-black bg-custom-blue-1	 rounded-lg">
                            ...
                            <div className="flex gap-2">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-xs text-black/40 dark:text-white/40">Today, 11:59 AM</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div>
                        ...
                        <div className="flex flex-col gap-4">
                            <div className="relative flex gap-2">
                                ...
                                <div className="absolute  h-3.5	top-8 left-3 w-px bg-black/10 dark:bg-white/20"></div>
                                <div className="flex-1">
                                    <p className="whitespace-nowrap overflow-hidden text-ellipsis w-[200px] text-black dark:text-white">
                                        You have a bug that needs...
                                    </p>
                                    <p className="text-xs text-black/40 dark:text-white/40">Just ago</p>
                                </div>
                            </div>
                            ...
                            <div className="relative flex gap-2">
                                ...
                                <div className="absolute top-8 left-3 h-3.5	w-px bg-black/10 dark:bg-white/20"></div>
                                <div className="flex-1">
                                    <p className="whitespace-nowrap overflow-hidden text-ellipsis w-[200px] text-black dark:text-white">
                            ...
                            <div className="relative flex gap-2">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-xs text-black/40 dark:text-white/40">Feb 2, 2023</p>
                                </div>
                            </div>
                        </div>
                    </div>
